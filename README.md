...
> Welcome to my blog! Here, let us study popular games, learn game strategies, and improve game skills
...
```yml
title: YaGaming
subtitle: Game guide introduction to improve game skills
description: Welcome to my blog! Here, let us study popular games, learn game strategies, and improve game skills
keywords:
# 作者名称，会显示在侧边栏
author: ya
```
...
```yml
card_author:
  description: Game guide introduction to improve game skills
```
...
```sh
# 克隆仓库
$ git clone https://github.com/zizhuspot/gaming.varygames.com.git
# 安装依赖
$ yarn install
# 运行
$ yarn server
